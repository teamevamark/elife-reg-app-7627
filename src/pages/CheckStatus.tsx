              ...
              <CardContent className="space-y-6">
                ...
                {registration.status === 'pending' && (registration.fee ?? 0) > 0 && <div className="mt-4 p-4 border rounded-lg bg-muted">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      ...
                      <br />
                      <span className="text-green-600 font-medium">പണം അടച്ചതിനു ശേഷവും പെന്റിങ് കാണിക്കുകയാണെങ്കിൽ മുകളിൽ കാണുന്ന വാട്ട്സ് ആപ്പ് (പച്ച ബട്ടൺ) ബട്ടൺ നോക്കിയാൽ നിങ്ങളുടെ പണമടച്ച സ്ക്രീൻ ഷോട്ട് അയക്കാവുന്നതാണ് </span>
                    </p>
